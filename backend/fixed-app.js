...
// Basic root route
app.get('/', (req, res) => {
    res.send('Hello from Ketso Cafe Backend (Fixed Version)');
});

// Define menu category routes directly
...
db.sequelize.authenticate()
    ...
    .then(() => {
        ...
        app.listen(port, () => {
            console.log(`Ketso Cafe backend (Fixed) listening at http://localhost:${port}`);

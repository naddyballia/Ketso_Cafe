...
// Basic root route
app.get('/', (req, res) => {
    res.send('Hello from Ketso Cafe Backend (New Version)');
});

// Define menu category routes directly with inline handlers
...
db.sequelize.authenticate()
    ...
    .then(() => {
        ...
        app.listen(port, () => {
            console.log(`Ketso Cafe backend (New) listening at http://localhost:${port}`);
